    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-transparent border-2 border-slate-200 rounded-xl focus:outline-none focus:border-sky-500 transition-colors duration-200 text-slate-900"
                {...props}
            />
        </div>
    );
...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute inset-[-100%] -z-10 animate-spin-slow bg-[conic-gradient(from_90deg_at_50%_50%,#e0f2fe_0%,#a5b4fc_50%,#e0f2fe_100%)] opacity-30" />

      <div className="relative z-10 flex min-h-screen">
        {/* Left Side */}
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-20">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="max-w-md">
            ...
            <h1 className="text-5xl xl:text-6xl font-extrabold tracking-tighter text-slate-900 mb-4">Your Career<br />
              <span className="bg-gradient-to-r from-sky-500 to-indigo-500 bg-clip-text text-transparent">Starts Here</span>
            </h1>
            <p className="text-lg xl:text-xl text-slate-600 mb-10 leading-relaxed">Join thousands of professionals accelerating their careers with AI-powered tools.</p>
            <AnimatedBenefits />
          </motion.div>
        </div>
            ...
            >
                <AnimatePresence mode="wait">
                    <motion.div
                        ...
                        className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-3xl p-8 shadow-2xl shadow-slate-400/20"
                    ...
                    >
                      ...
                      <form className="space-y-5">
                        ...
                        <p className="text-center pt-4 text-slate-600">
                          ...
                          <button type="button" onClick={() => setIsLogin(!isLogin)} className="ml-2 text-sky-500 hover:text-sky-600 font-semibold">
